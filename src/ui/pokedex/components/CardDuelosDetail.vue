    ...
    <div class="px-4 md:px-10 py-6">
      <div
        ...
        <div class="p-6 text-center text-white relative">
          ...
          <img :src="pokemon?.imgUrl" :alt="pokemon?.name" class="w-32 h-32 mx-auto" />
        </div>
        ...
        <div class="bg-white p-4 rounded-t-3xl">
          ...
          <div class="mt-4" v-show="showDetails || isDesktop">
            ...
            <div class="mt-4 flex justify-between items-center">
              <h3 class="text-gray-700 font-semibold">Base Stats</h3>
              <button @click="toggleStats" class="text-blue-600">
                <span v-if="showStats">▲</span>
                <span v-else>▼</span>
              </button>
            </div>
  
            <!-- Stats details hidden until toggle -->
